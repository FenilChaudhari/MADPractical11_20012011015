package com.example.madpractical11_20012011015
...
class DatabaseHelper(context: Context?) :
    ...
    private fun getNote(cursor: Cursor): Note {
        ...
        note.isReminder =
            (cursor.getInt(cursor.getColumnIndexOrThrow(NotesData.COLUMN_NOTE_SET_REMINDER)) == 1)
        note.remindertime =
            cursor.getLong(cursor.getColumnIndexOrThrow(NotesData.COLUMN_NOTE_REMINDER_TIME))
